...
import { productDetailStrings } from '../data/productDetailStrings';
...
export function ProductDetailPage() {
  ...
  const t = productDetailStrings[fr ? 'fr' : 'ar'];
    ...
    return (
      <div className="pt-20 min-h-screen bg-cream-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-charcoal-800 mb-4">{t.notFound}</h1>
  ...
  return (
    <div className="pt-20 min-h-screen bg-cream-50" dir={fr ? 'ltr' : 'rtl'}>
            ...
            <div>
              ...
              <div className={`flex gap-4 flex-wrap`}>
                <Button 
                  ...
                  className={`${!fr && 'flex flex-row-reverse'}`}
                  >
                  <ShoppingCart size={20} className="mx-2" />
                  {t.buyNow}
                </Button>
              </div>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-cream-200 sticky top-24">
              ...
              <div className="space-y-6 mb-8">
                <div>
                  <span className="block text-sm text-charcoal-500 mb-2">{t.availability}</span>
              ...
              <Button  
                to={wtsplink}
                disabled={product.inStock === false}
                className={`w-full mb-3 ${!fr && 'flex flex-row-reverse'}`}
                >
                <ShoppingCart size={20} className="mx-2" />
                {t.buyNow}
              </Button>
